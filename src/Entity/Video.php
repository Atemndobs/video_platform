...
class Video
{
  //  public const videoForNotLoggedIn = 289729765; // vimeo video id
    public const videoForNotLoggedInOrNoMembers = 'https://player.vimeo.com/video/289729765'; // vimeo video id
    ...
    public function getUploadedVideo() // take out strict type cus the video upload format is mp4 and not string
    {
        return $this->uploaded_video;
    }

    public function setUploadedVideo($uploaded_video): self  // remove strict typing
    {
